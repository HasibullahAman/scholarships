...
const Footer = () => {
    return (
        <div>
            ...
            <footer className="footer footer-horizontal footer-center bg-base-200 text-base-content rounded p-10 grid">
                <nav className="grid sm:grid-flow-col sm:text-xl sm:gap-14">

                    <a className="link link-hover flex items-center space-x-2!">
                ...
                <aside>
                    <p>Copyright © {new Date().getFullYear()} - All right reserved by Hasibullah Aman</p>
                </aside>
            </footer>
        </div>
    );
